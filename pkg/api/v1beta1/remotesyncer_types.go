...
type RemoteSyncerSpec struct {
	...
	ProcessMode ProcessMode `json:"processMode"`

	// +optional
	DefaultBlockAppliedMessage string `json:"defaultBlockAppliedMessage,omitempty"`
	...
	// +optional
	DefaultRemoteUserRef *corev1.ObjectReference `json:"defaultUser,omitempty"` // Ref to a RemoteUser object
	...
	// +optional
	ExcludedFieldsConfigMapRef *corev1.ObjectReference `json:"excludedFieldsConfig,omitempty"` // Ref to a ConfigMap

	// +optional
	InsecureSkipTlsVerify bool `json:"insecureSkipTlsVerify,omitempty"`

	// +optional
	CABundleSecretRef corev1.SecretReference `json:"caBundle,omitempty"`
}
