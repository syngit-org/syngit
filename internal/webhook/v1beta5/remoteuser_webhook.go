...
func SetupRemoteUserWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &syngitv1beta5.RemoteUser{}).
		WithValidator(&RemoteUserCustomValidator{}).
		Complete()
}

// +kubebuilder:webhook:path=/validate-syngit-io-v1beta5-remoteuser,mutating=false,failurePolicy=fail,sideEffects=None,groups=syngit.io,resources=remoteusers,verbs=create;update,versions=v1beta5,name=vremoteuser-v1beta5.kb.io,admissionReviewVersions=v1
...
func (v *RemoteUserCustomValidator) ValidateCreate(ctx context.Context, remoteuser *syngitv1beta5.RemoteUser) (admission.Warnings, error) {
...
func (v *RemoteUserCustomValidator) ValidateUpdate(ctx context.Context, oldObj, newRemoteuser *syngitv1beta5.RemoteUser) (admission.Warnings, error) {
...
func (v *RemoteUserCustomValidator) ValidateDelete(ctx context.Context, remoteuser *syngitv1beta5.RemoteUser) (admission.Warnings, error) {
