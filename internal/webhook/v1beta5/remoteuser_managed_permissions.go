...
// +kubebuilder:webhook:path=/syngit-v1beta5-remoteuser-managed,mutating=true,failurePolicy=fail,sideEffects=None,groups=syngit.io,resources=remoteusers,verbs=create;update;delete,versions=v1beta5,admissionReviewVersions=v1,name=mremoteusers-managed.v1beta5.syngit.io,reinvocationPolicy=Never
