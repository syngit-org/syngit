...
func SetupRemoteUserBindingWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &syngitv1beta5.RemoteUserBinding{}).
		WithValidator(&RemoteUserBindingCustomValidator{}).
		Complete()
}

// +kubebuilder:webhook:path=/validate-syngit-io-v1beta5-remoteuserbinding,mutating=false,failurePolicy=fail,sideEffects=None,groups=syngit.io,resources=remoteuserbindings,verbs=create;update,versions=v1beta5,name=vremoteuserbinding-v1beta5.kb.io,admissionReviewVersions=v1
...
func validateRemoteUserBinding(remoteUserBinding *syngitv1beta5.RemoteUserBinding) error {
...
func (v *RemoteUserBindingCustomValidator) ValidateCreate(ctx context.Context, remoteuserbinding *syngitv1beta5.RemoteUserBinding) (admission.Warnings, error) {
...
func (v *RemoteUserBindingCustomValidator) ValidateUpdate(ctx context.Context, oldObj, newRemoteuserbinding *syngitv1beta5.RemoteUserBinding) (admission.Warnings, error) {
...
func (v *RemoteUserBindingCustomValidator) ValidateDelete(ctx context.Context, remoteuserbinding *syngitv1beta5.RemoteUserBinding) (admission.Warnings, error) {
