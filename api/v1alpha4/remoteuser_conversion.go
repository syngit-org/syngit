...
func (src *RemoteUser) ConvertTo(dstRaw conversion.Hub) error {
	...
	associatedRemoteUserBinding := src.Spec.OwnRemoteUserBinding
...
func (dst *RemoteUser) ConvertFrom(srcRaw conversion.Hub) error {
	...
	associatedRemoteUserBinding := src.Spec.AssociatedRemoteUserBinding
	dst.Spec.OwnRemoteUserBinding = associatedRemoteUserBinding
